...
from v2 import independent_model_replay as replay  # noqa: E402
from v2.development_corpus import verify_rights_evidence  # noqa: E402


PLAN_SCHEMA = "corelm-crossmodel-v2-real-e2e-development-plan-v1"
JOB_SCHEMA = "corelm-crossmodel-v2-real-e2e-development-worker-job-v1"
SUMMARY_SCHEMA = "corelm-crossmodel-v2-real-e2e-development-model-replay-v1"
...
CORPUS_MANIFEST_SHA256 = (
    "ce46322376c6795606ef9d651290f5db303a6bcf09075dfcada7db1a729ef402"
)
CORPORA = (DATASET_ID,)
MODEL_FILES = (
    "config.json",
...
RAW_TOKEN_SCHEMA = "corelm-crossmodel-v2-real-e2e-development-raw-token-v1"
PAGE_TOKEN_SCHEMA = "corelm-crossmodel-v2-real-e2e-development-page-token-v1"
CONTAINER_SCHEMA = "corelm-crossmodel-v2-real-e2e-development-container-v1"
...
def validate_plan(plan: Any) -> None:
    ...
    if bindings["modelAssetManifest"] != {
        "bytes": 6381,
        "sha256": "0e8c8bfa52b76662c5cb349ef1d6525db7f8534985046bfd4a629b3f3353683b",
    }:
        raise DevelopmentReplayError("development model manifest differs")
    if bindings["fullAssetReceipt"] != {
        "bytes": 4272,
        "sha256": "0e57aa43f52569cf6910a248ee2ad4ee36dcf73d7c8ce9f33a4f50f738d5f5c2",
    }:
