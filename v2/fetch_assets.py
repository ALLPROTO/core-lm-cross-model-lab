#!/usr/bin/env python3
"""Fetch immutable v2 model assets with exact, fail-closed verification.
...
MANIFEST_SCHEMA = "corelm-crossmodel-livewiki-v2-model-assets-draft-v1"
    ...
    try:
        ...
        request = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "corelm-v2-asset-fetcher/1",
            },
            method="GET",
        )
