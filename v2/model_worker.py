#!/usr/bin/env python3
"""Networkless, one-model worker for the frozen blind-v2 experiment.
...
from v2.cache_adapter import (  # noqa: E402
    build_dynamic_cache,
    flatten_kv_numpy,
...
from v2.mediawiki_snapshot import parse_record  # noqa: E402
...
from v2.protocol import canonical_json_bytes, load_json_strict  # noqa: E402
...
SCIENTIFIC_JOB_SCHEMA = "corelm-crossmodel-livewiki-v2-worker-job-v1"
SCIENTIFIC_SUITE_ID = "corelm-voidtoken-crossmodel-livewiki-v2"
DEVELOPMENT_JOB_SCHEMA = (
    "corelm-crossmodel-v2-real-e2e-development-worker-job-v1"
)
...
DEVELOPMENT_RAW_TOKEN_SCHEMA = (
    "corelm-crossmodel-v2-real-e2e-development-raw-token-v1"
)
DEVELOPMENT_PAGE_TOKEN_SCHEMA = (
    "corelm-crossmodel-v2-real-e2e-development-page-token-v1"
)
DEVELOPMENT_CONTAINER_SCHEMA = (
    "corelm-crossmodel-v2-real-e2e-development-container-v1"
)
...
def run(job_path: Path, snapshot_root: Path, codec_root: Path, output_root: Path) -> Path:
    ...
    summary = {
        "schemaVersion": (
            DEVELOPMENT_SUMMARY_SCHEMA
            if development
            else "corelm-crossmodel-livewiki-v2-worker-summary-v1"
        ),
        "suiteId": job["suiteId"],
