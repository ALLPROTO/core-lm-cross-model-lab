...
signed annotated tag `corelm-crossmodel-livewiki-v2-closeout`, published
strictly before `2026-09-08T18:00:00Z`. Its exact four semantic roles are:
...
`2026-08-29T18:00:00Z`. Its claim is deliberately limited to the named result
...
```sh
python3 -I -B v2/collect_empty_result_root.py \
...
```sh
python3 -I -B v2/package_closeout_release.py package \
...
python3 -I -B v2/package_closeout_release.py package \
  ...
  --expected-public-key-sha256 '7e0fab5da5fd49258faebf8b2f581b517159c0290aaff2fb1f79c77c9febba3c' \
  --cosign /absolute/path/to/pinned-cosign-v3.0.6 \
  --output-directory /new/path/closeout-release
```
...
```sh
python3 -I -B v2/package_closeout_release.py verify-published \
