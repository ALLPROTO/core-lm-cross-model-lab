#!/usr/bin/env python3
"""Build and independently verify a blind-v2 public evidence package.
...
replace ``v2/verify_evidence.py``, which independently recomputes the scientific
...
SCHEMA_VERSION = "corelm-crossmodel-livewiki-v2-evidence-release-manifest-v1"
VERIFICATION_SCHEMA = (
    "corelm-crossmodel-livewiki-v2-evidence-release-verification-v1"
)
...
def _validate_marker(raw: bytes) -> dict[str, Any]:
    ...
    if (
        marker["schemaVersion"] != "corelm-crossmodel-livewiki-v2-attempt-v1"
...
def _validate_outcome(
    ...
    if (
        outcome["schemaVersion"] != "corelm-crossmodel-livewiki-v2-outcome-v1"
...
def _verify_inner_evidence_manifest(
    ...
    if manifest["schemaVersion"] != "corelm-crossmodel-livewiki-v2-evidence-manifest-v1":
