...
The review/CI collector separately preserves responses obtained over direct,
...
```bash
python3 -m v2.create_zenodo_deposit_manifest \
...
python3 -m v2.collect_zenodo_receipt \
...
```bash
python3 -m v2.verify_zenodo_receipt \
