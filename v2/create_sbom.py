#!/usr/bin/env python3
"""Build a deterministic CycloneDX SBOM from verified v2 provenance receipts."""
...
def build_sbom(runtime: dict[str, Any], assets: dict[str, Any]) -> dict[str, Any]:
    ...
    if runtime.get("schemaVersion") != "corelm-crossmodel-livewiki-v2-runtime-manifest-v1":
        raise ValueError("unexpected runtime manifest schema")
    if assets.get("schemaVersion") != "corelm-crossmodel-livewiki-v2-asset-receipt-v1":
