#!/usr/bin/env python3
"""Collect and independently replay the registered blind-v2 corpus snapshot.
...
from v2.fetch_assets import (  # noqa: E402
    DEFAULT_MANIFEST,
    AssetFetchError,
    AssetSpecification,
    load_manifest,
...
from v2.protocol import sha256_bytes  # noqa: E402
...
def _freeze_ready_report(
    *,
    ...
    return {
        "schemaVersion": "corelm-crossmodel-livewiki-v2-collector-run-v1",
    ...
    *,
    ...
    if phase in {"crawl-1", "crawl-2"}:
        ...
        if (
            ...
            raise CollectorCLIError("crawl stage completion manifest differs")
        return {
            "schemaVersion": "corelm-crossmodel-livewiki-v2-collector-stage-run-v1",
