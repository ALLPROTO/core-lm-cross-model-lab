...
KINDS = frozenset(
    ("development-control", "design", "snapshot", "evidence", "closeout")
)
...
TRACKED_SSH_PUBLIC_KEY_PATH = (
    V2_ROOT / "signing/corelm-crossmodel-v2-signing.pub"
)
TRACKED_SSH_ALLOWED_SIGNERS_PATH = V2_ROOT / "signing/allowed_signers"
