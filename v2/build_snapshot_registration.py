#!/usr/bin/env python3
"""Build the pre-publication blind-v2 snapshot registration offline.
...
from v2.mediawiki_snapshot import verify_corpus_snapshot  # noqa: E402
from v2.collect_snapshot import (  # noqa: E402
...
from v2.publication import PublicationError, verify_publication  # noqa: E402
...
from v2.reproducibility import verify_content_digest, write_new_bytes  # noqa: E402


SUITE_ID = "corelm-voidtoken-crossmodel-livewiki-v2"
SNAPSHOT_SCHEMA = "corelm-crossmodel-livewiki-v2-snapshot-registration-v1"
CORPUS_SCHEMA = "corelm-crossmodel-livewiki-v2-corpus-manifest-v1"
...
def build_snapshot_registration_to_path(*, output: Path, **inputs: Any) -> bytes:
    ...
    reviewed_root = PROJECT_ROOT.resolve(strict=True)
    try:
        destination.relative_to(reviewed_root)
    except ValueError:
        pass
    else:
        raise SnapshotRegistrationBuildError(
            "snapshot output must remain outside the reviewed lab checkout"
        )
