#!/usr/bin/env python3
"""Independent blind-v2 raw-evidence arithmetic and container verification."""
...
from v2.protocol import canonical_json_bytes, evaluate_model_aggregate
...
def verify_sha256_manifest(root: Path, manifest_path: Path) -> tuple[dict[str, Any], str]:
    ...
    if value["schemaVersion"] != "corelm-crossmodel-livewiki-v2-evidence-manifest-v1":
