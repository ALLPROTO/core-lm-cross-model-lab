#!/usr/bin/env python3
"""Collect one direct-TLS GitHub review + Actions structural observation."""
...
GITHUB_API_PORT = 443
USER_AGENT = "core-lm-github-gate-collector/1"
...
class GitHubGateCollectionError(RuntimeError):
    """The GitHub gate could not be collected and verified."""
...
def collect_github_gate_receipt(
    *,
    ...
    try:
        ...
        raise GitHubGateCollectionError("GitHub review/CI gate did not pass") from error
