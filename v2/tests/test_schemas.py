...
from v2.evidence import CONTAINER_SCHEMA, PAGE_TOKEN_SCHEMA, RAW_TOKEN_SCHEMA
from v2.github_gate_receipt import EVIDENCE_BOUNDARY, REQUIRED_REVIEW_DECLARATION
...
class SchemaIntegrityTests(unittest.TestCase):
    ...
    def test_schemas_are_strict_closed_draft_2020_12_documents(self) -> None:
        ...
        for name, schema in schemas.items():
            ...
            self.assertTrue(schema["$id"].endswith(f"/v2/schemas/{name}"))
    ...
    def test_design_schema_covers_the_exact_tracked_registration_boundary(self) -> None:
        ...
        self.assertEqual(
            replay["implementation"], "v2/independent_model_replay.py"
        )
    ...
    def test_design_lifecycle_branches_fail_closed_and_snapshot_plan_is_exact(self) -> None:
        ...
        self.assertEqual(
            ...
            "corelm-crossmodel-livewiki-v2-snapshot",
        )
        self.assertEqual(
