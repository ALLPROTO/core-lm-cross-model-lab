...
from v2.collect_zenodo_receipt import (
    ZenodoReceiptCollectionError,
    _validate_exact_url,
    collect_zenodo_receipt_to_path,
    load_token_from_environment,
)
from v2.tests.test_zenodo_archive import CREATED, DEPOSITION_ID, DOI, RECORD_ID, ZenodoFixture
from v2.zenodo_archive import HTTPSCapture
