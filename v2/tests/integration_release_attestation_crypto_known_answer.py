...
from v2.github_release_attestation import build_attestation_record  # noqa: E402
...
from v2.reproducibility import canonical_json_bytes  # noqa: E402


VECTOR_ROOT = V2_ROOT / "test-vectors" / "github-release-attestation-v1"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="OS-level network isolation applied by the reviewed caller",
    )
