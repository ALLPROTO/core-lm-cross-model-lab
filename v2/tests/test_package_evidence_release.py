...
import v2.package_evidence_release as subject

from v2.package_evidence_release import (
    ARTIFACT_PATHS,
...
class EvidenceReleasePackageTests(unittest.TestCase):
    ...
    def build_sources(self, state: str | None) -> dict[str, Path]:
        ...
        github_gate_raw = canonical_line(
            {
                "schemaVersion": (
                    "corelm-crossmodel-livewiki-v2-github-gate-receipt-v1"
                ),
                "fixture": True,
            }
        )
        ...
        asset_source_raw = canonical_line(
            {
                "schemaVersion": (
                    "corelm-crossmodel-livewiki-v2-model-assets-draft-v1"
                ),
        ...
        snapshot_raw = canonical_line(
            {
                "schemaVersion": "corelm-crossmodel-livewiki-v2-snapshot-v1",
                "suiteId": SUITE_ID,
        ...
        marker = {
            ...
            "labCommit": "3" * 40,
            "labTree": "4" * 40,
            "targetPulseTimestamp": "2026-08-27T18:00:00.000Z",
        ...
        if state in {"PASS", "FAIL_GATES"}:
            ...
            replay_summary = {
                "schemaVersion": (
                    "corelm-crossmodel-livewiki-v2-independent-model-replay-v1"
                ),
                "suiteId": SUITE_ID,
                "attemptId": ATTEMPT_ID,
                "replayComplete": True,
            ...
            report_raw = canonical_line(
                {
                    "schemaVersion": "corelm-crossmodel-livewiki-v2-independent-verification-v1",
                    "suiteId": SUITE_ID,
                    "attemptId": ATTEMPT_ID,
                    "verdict": state,
            ...
            evidence_manifest_raw = canonical_line(
                {
                    "schemaVersion": "corelm-crossmodel-livewiki-v2-evidence-manifest-v1",
            ...
            outcome = {
                ...
                "attemptId": ATTEMPT_ID,
                "terminalState": state,
                "completedAt": "2026-08-28T19:00:00Z",
            ...
            outcome = {
                ...
                "attemptId": ATTEMPT_ID,
                "terminalState": state,
                "completedAt": "2026-08-28T18:01:00Z",
                "attemptMarkerFileSHA256": sha256_bytes(marker_raw),
                "resultSHA256": None,
