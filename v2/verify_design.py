#!/usr/bin/env python3
"""Verify the offline blind-v2 design draft and known-answer selector."""
...
def main() -> int:
    ...
    registration_path = V2_ROOT / "design-registration.draft.json"
    vector_path = V2_ROOT / "test-vectors" / "selection-v1.json"
