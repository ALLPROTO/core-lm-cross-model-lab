#!/usr/bin/env python3
"""Pure, offline protocol controls for the prospective blind v4 suite."""
...
DOMAIN = b"corelm-voidtoken-crossmodel-livewiki-v4-author-verified/select\0"
...
CORPUS_START = datetime(2026, 9, 8, tzinfo=timezone.utc)
CORPUS_END = datetime(2026, 9, 22, tzinfo=timezone.utc)
DESIGN_RELEASE_DEADLINE = datetime(2026, 9, 7, tzinfo=timezone.utc)
SNAPSHOT_RELEASE_NOT_BEFORE = datetime(2026, 9, 23, 6, tzinfo=timezone.utc)
SNAPSHOT_RELEASE_DEADLINE = datetime(2026, 9, 24, 18, tzinfo=timezone.utc)
...
EXPECTED_DEVELOPMENT_CONTROLS = {
    ...
    "dataset": {
        ...
        "manifestBytes": 1_985,
        "manifestSHA256": "eed647bcf91ffb1f82a6a41cdc72a3b5bda00825497a4523a7a5966e25fe1b87",
    },
    "allowedEntryPoints": [
        {
            "path": "v4/run_real_e2e_control.py",
    ...
    "realDataE2EFreezeGate": {
        "required": True,
        "reportSchemaVersion": (
            "corelm-crossmodel-v4-real-e2e-development-report-v1"
        ),
        "reportFileName": "development-control-report.json",
        "completeNoLaterThan": "2026-09-07T00:00:00Z",
        "serverTimestampedArchiveRequired": True,
        "archiveTag": "corelm-crossmodel-livewiki-v4-development-control",
...
EXPECTED_CONTINUOUS_INTEGRATION = {
    "workflowName": "Author-verified v4 development controls",
    "workflowPath": ".github/workflows/v4-development-controls.yml",
    "workflowFileBytes": 13560,
    "workflowFileSHA256": (
...
def validate_snapshot_registration(snapshot: Any, *, allow_fixture: bool) -> None:
    ...
    if schema == "corelm-crossmodel-livewiki-v4-snapshot-fixture-v1":
        if not allow_fixture:
            raise ValueError("protocol-control snapshot fixture is forbidden here")
        expected_fixture = {
            "schemaVersion": "corelm-crossmodel-livewiki-v4-snapshot-fixture-v1",
            "fixtureOnly": True,
        ...
        return
    if schema != "corelm-crossmodel-livewiki-v4-snapshot-registration-v1":
    ...
    expected_release_plan = {
        "tag": "corelm-crossmodel-livewiki-v4-snapshot",
        "publishNoLaterThan": "2026-09-24T18:00:00Z",
...
def resolve_selection(
    ...
    *,
    ...
    fixture_mode = (
        ...
        == "corelm-crossmodel-livewiki-v4-snapshot-fixture-v1"
    )
    ...
    return {
        "schemaVersion": "corelm-crossmodel-livewiki-v4-selection-v1",
        "suiteId": SUITE_ID,
...
def validate_design_registration(registration: Any) -> list[str]:
    ...
    if registration.get("schemaVersion") != "corelm-crossmodel-livewiki-v4-design-draft-v1":
    ...
    expected_scientific_boundary = (
        ...
        "text, latency, throughput, weight compression, or state of the art. It is "
        "author-operated and author-self-verified; no independent human review, peer "
        "review, operator blindness, independent replication, or independent validation "
        "is claimed."
    )
    ...
    expected_design_release = {
        "tag": "corelm-crossmodel-livewiki-v4-design",
        "publishNoLaterThan": "2026-09-07T00:00:00Z",
    ...
    expected_future_corpus = {
        ...
        "creationInterval": {
            ...
            "endExclusive": "2026-09-22T00:00:00Z",
        },
        "snapshotPolicy": "union-of-two-complete-archived-recentchanges-crawls",
        "firstCrawlNotBefore": "2026-09-22T06:00:00Z",
        "secondCrawlNotBefore": "2026-09-23T06:00:00Z",
    ...
    expected_evidence_release = {
        "tag": "corelm-crossmodel-livewiki-v4-evidence",
        "publishNoLaterThan": "2026-09-30T18:00:00Z",
        "sourcePolicy": "EXACT_FROZEN_DESIGN_LAB_SOURCE_COMMIT_TREE",
        "serverTimestampRequired": True,
        "immutableReleaseRequired": True,
        "signedAnnotatedTagRequired": True,
    ...
    expected_closeout_release = {
        "tag": "corelm-crossmodel-livewiki-v4-closeout",
        "publishNoLaterThan": "2026-10-07T18:00:00Z",
        "sourcePolicy": "EXACT_FROZEN_DESIGN_LAB_SOURCE_COMMIT_TREE",
        "serverTimestampRequired": True,
        "immutableReleaseRequired": True,
        "signedAnnotatedTagRequired": True,
    ...
    expected_reschedule_policy = {
        "decisionCheckpoint": "2026-09-06T12:00:00Z",
    ...
    for model in models:
        ...
        if model.get("usedForCandidateSelectionOrTuning") is not False:
            raise ValueError("v4 model was used for candidate selection or tuning")
    ...
    expected_execution = {
        ...
        "independentModelReplay": {
            ...
            "implementation": "v4/independent_model_replay.py",
        ...
        "oneShotNotBefore": "2026-09-26T18:00:00Z",
        "hardDeadline": "2026-09-27T18:00:00Z",
    }
    if registration.get("execution") != expected_execution:
        raise ValueError("execution boundary differs")
    expected_beacon = {
        "targetTimestamp": "2026-09-25T18:00:00.000Z",
        "targetUnixMilliseconds": 1790359200000,
        "pulseEndpoint": "https://beacon.nist.gov/beacon/2.0/pulse/time/1790359200000",
        "pulseVersion": "2.0",
        "pulseCipherSuite": 0,
        "pulsePeriodMilliseconds": 60000,
        "transportCABundleSHA256": "22b557a27055b33606b6559f37703928d3e4ad79f110b407d04986e1843543d1",
        "offlineTrustBundleSHA256": "6b076628457867d3e14e4be46182aac9f72dc6b3c505f5cd207f7ed759785715",
...
def validate_frozen_design_registration(registration: Any) -> list[str]:
    ...
    if set(registration) != EXPECTED_TOP_LEVEL_FIELDS:
        raise ValueError("design registration top-level fields differ")
    if registration.get("schemaVersion") != "corelm-crossmodel-livewiki-v4-design-v1":
    ...
    normalized["schemaVersion"] = "corelm-crossmodel-livewiki-v4-design-draft-v1"
...
def validate_design_registration_lifecycle(registration: Any) -> list[str]:
    ...
    if identity == (
        "corelm-crossmodel-livewiki-v4-design-draft-v1",
        "DRAFT_NOT_PREREGISTERED",
    ):
        return validate_design_registration(registration)
    if identity == (
        "corelm-crossmodel-livewiki-v4-design-v1",
...
def validate_model_asset_manifest(
    ...
    if manifest.get("schemaVersion") != "corelm-crossmodel-livewiki-v4-model-assets-draft-v1":
