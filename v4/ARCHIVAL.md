...
as the mandatory exact-commit v4 development control.
...
```bash
python3 -m v4.create_zenodo_deposit_manifest \
...
python3 -m v4.collect_zenodo_receipt \
...
```bash
python3 -m v4.verify_zenodo_receipt \
