...
INNER_MANIFEST_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-evidence-release-manifest-v1"
)
INNER_REPORT_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-evidence-release-verification-v1"
)
SHA256_MANIFEST_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-evidence-release-sha256-manifest-v1"
)
VERIFICATION_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-evidence-assets-verification-v1"
)
