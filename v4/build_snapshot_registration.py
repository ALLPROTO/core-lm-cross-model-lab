#!/usr/bin/env python3
"""Build the pre-publication blind-v4 snapshot registration offline.
...
from v4.mediawiki_snapshot import verify_corpus_snapshot  # noqa: E402
from v4.collect_snapshot import (  # noqa: E402
...
from v4.publication import PublicationError, verify_publication  # noqa: E402
...
from v4.reproducibility import verify_content_digest, write_new_bytes  # noqa: E402


SUITE_ID = "corelm-voidtoken-crossmodel-livewiki-v4-author-verified"
SNAPSHOT_SCHEMA = "corelm-crossmodel-livewiki-v4-snapshot-registration-v1"
CORPUS_SCHEMA = "corelm-crossmodel-livewiki-v4-corpus-manifest-v1"
