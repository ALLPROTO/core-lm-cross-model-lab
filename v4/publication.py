...
SIGNER_IDENTITY = "corelm-crossmodel-livewiki-v4-release"
...
def verify_ssh_signing_key(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="corelm-v4-key-check-") as temporary:
...
def verify_archived_ssh_tag_signature(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="corelm-v4-ssh-verify-") as temporary:
        root = Path(temporary)
