#!/usr/bin/env python3
"""Create and verify the non-self-referential author-verified v4 freeze manifest.
...
from v4.mediawiki_snapshot import PROJECTS, PinnedHTTPSClient  # noqa: E402
from v4.development_artifact_verifier import (  # noqa: E402
...
from v4.github_gate_receipt import (  # noqa: E402
...
from v4.nist_beacon import (  # noqa: E402
    NIST_TRUST_ROOT_DER_SHA256,
    load_offline_trust_bundle,
)
from v4.protocol import (  # noqa: E402
    load_json_strict_bytes,
    validate_frozen_design_registration,
)
from v4.reproducibility import (  # noqa: E402
...
from v4.release_receipt import (  # noqa: E402
    ReleaseAttestationCryptographicVerifier,
    ReleaseReceiptError,
    verify_release_receipt,
)
from v4.release_attestation_crypto import (  # noqa: E402
    PinnedCosignReleaseAttestationVerifier,
)


SCHEMA_VERSION = "corelm-crossmodel-livewiki-v4-freeze-manifest-v1"
STATUS = "IMPLEMENTATION_FREEZE_READY_FOR_DESIGN_BINDING"
SUITE_ID = "corelm-voidtoken-crossmodel-livewiki-v4-author-verified"
RUNTIME_SCHEMA = "corelm-crossmodel-livewiki-v4-runtime-manifest-v1"
ASSET_RECEIPT_SCHEMA = "corelm-crossmodel-livewiki-v4-asset-receipt-v1"
TRUST_SCHEMA = "corelm-crossmodel-livewiki-v4-nist-trust-bundle-v1"
PULSE_TIME = datetime(2026, 9, 25, 18, 0, 0, tzinfo=timezone.utc)
DECISION_CHECKPOINT = datetime(2026, 9, 6, 12, 0, 0, tzinfo=timezone.utc)
DESIGN_PUBLISH_DEADLINE = datetime(2026, 9, 7, 0, 0, 0, tzinfo=timezone.utc)
...
DEVELOPMENT_ARCHIVE_MANIFEST_SCHEMA = (
    "corelm-crossmodel-v4-real-e2e-development-archive-manifest-v1"
)
DEVELOPMENT_ARCHIVE_TAG = (
    "corelm-crossmodel-livewiki-v4-development-control"
)
...
DEVELOPMENT_PLAN_SCHEMA = "corelm-crossmodel-v4-real-e2e-development-plan-v1"
DEVELOPMENT_REPLAY_SCHEMA = (
    "corelm-crossmodel-v4-real-e2e-development-model-replay-v1"
)
...
DEVELOPMENT_SUPERVISOR_SCHEMA = (
    "corelm-crossmodel-v4-real-e2e-development-supervisor-receipt-v1"
)
...
DEVELOPMENT_CONTROL_SOURCE_PATHS = (
    ...
    "v4/development_model_replay.py",
    "v4/development_corpus.py",
    "v4/development_runtime.py",
    "v4/development_artifact_verifier.py",
    "v4/freeze_manifest.py",
    "v4/model_worker.py",
    "v4/independent_model_replay.py",
    "v4/cache_adapter.py",
    "v4/evidence.py",
    "v4/mediawiki_snapshot.py",
    "v4/protocol.py",
    "v4/reproducibility.py",
    "v4/create_asset_receipt.py",
    "v4/preflight.py",
    "v4/fetch_assets.py",
)
DEVELOPMENT_ARCHIVED_INPUTS = {
    "designRegistration": (
        ...
        "v4/design-registration.draft.json",
    ),
    "modelAssetManifest": (
        "inputs/model-assets.draft.json",
        "v4/model-assets.draft.json",
    ),
    "fullAssetReceipt": (
    ...
    "developmentCorpusManifest": (
        ...
        "v4/development-corpus.draft.json",
    ),
...
def _validate_development_rights_evidence(
    ...
    try:
        ...
        tracked_manifest_raw = read_regular_bytes(
            V4_ROOT / "development-corpus.draft.json",
...
def _validate_development_plan(
    ...
    *,
    ...
    tracked_design_raw = read_regular_bytes(
        V4_ROOT / "design-registration.draft.json",
        maximum_bytes=MAX_DESIGN_BYTES,
    )
    try:
    ...
    configuration = {
        "schemaVersion": "corelm-crossmodel-v4-real-e2e-development-configuration-v1",
...
def verify_development_control_report(
    ...
    *,
    ...
    if (
        ...
        != "corelm-crossmodel-v4-real-e2e-development-start-v1"
    ...
    *,
    ...
    try:
        verified = verify_release_receipt(
            ...
            expected_deadline="2026-09-07T00:00:00Z",
