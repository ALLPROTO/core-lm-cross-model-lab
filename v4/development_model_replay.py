...
from v4 import independent_model_replay as replay  # noqa: E402
from v4.development_corpus import verify_rights_evidence  # noqa: E402


PLAN_SCHEMA = "corelm-crossmodel-v4-real-e2e-development-plan-v1"
JOB_SCHEMA = "corelm-crossmodel-v4-real-e2e-development-worker-job-v1"
SUMMARY_SCHEMA = "corelm-crossmodel-v4-real-e2e-development-model-replay-v1"
SUITE_ID = "corelm-voidtoken-crossmodel-v4-author-verified-development-e2e"
...
RAW_TOKEN_SCHEMA = "corelm-crossmodel-v4-real-e2e-development-raw-token-v1"
PAGE_TOKEN_SCHEMA = "corelm-crossmodel-v4-real-e2e-development-page-token-v1"
CONTAINER_SCHEMA = "corelm-crossmodel-v4-real-e2e-development-container-v1"
...
EXPECTED_CORPUS_MANIFEST = {
    "schemaVersion": "corelm-crossmodel-livewiki-v4-development-corpus-v1",
...
def validate_plan(plan: Any) -> None:
    ...
    if bindings["modelAssetManifest"] != {
        "bytes": 6381,
        "sha256": "b851aa9842aae5895f411803e6157dd2072c026d6856290ca50dcbf2fe2fbf8f",
    }:
        raise DevelopmentReplayError("development model manifest differs")
    if bindings["fullAssetReceipt"] != {
        "bytes": 4272,
        "sha256": "0491df1d1352a0954d9f077ae5c4875896baacd14a4db7323ebb86f800b40eb4",
    }:
