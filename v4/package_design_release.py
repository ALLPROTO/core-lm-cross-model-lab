...
``v4.release_receipt`` verifies it separately.
"""
...
from v4 import freeze_manifest  # noqa: E402
...
from v4.release_receipt import REQUIRED_ASSET_ROLES  # noqa: E402
...
SHA256_MANIFEST_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-design-release-sha256-manifest-v1"
)
VERIFICATION_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-design-release-verification-v1"
)
...
class CIArtifactVerification:
    ...
    def as_dict(self) -> dict[str, Any]:
        return {
            "schemaVersion": (
                "corelm-crossmodel-livewiki-v4-ci-artifact-verification-v1"
            ),
            "suiteId": SUITE_ID,
...
def _verify_ci_artifact_payload(
    *,
    ...
    names = {
        "preflight": f"v4-preflight-{suffix}.json",
        "runtime-manifest": f"v4-runtime-{suffix}.json",
        "zero-skip-log": f"v4-zero-skip-{suffix}.log",
        "design-check": f"v4-design-check-{suffix}.json",
    ...
    if (
        ...
        != "corelm-crossmodel-livewiki-v4-preflight-v1"
    ...
    if (
        ...
        != "corelm-crossmodel-livewiki-v4-design-check-v1"
...
def _verify_bindings(
    ...
    *,
    ...
    if (
        ...
        or archive_release.get("deadline") != "2026-09-07T00:00:00Z"
