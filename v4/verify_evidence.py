#!/usr/bin/env python3
"""Recompute the complete blind-v4 verdict from frozen raw evidence."""
...
from v4.create_sbom import build_sbom  # noqa: E402
from v4.git_source import GitSourceError, verify_copied_source  # noqa: E402
...
from v4.independent_verifier_core import (  # noqa: E402
...
from v4.independent_model_replay import (  # noqa: E402
...
def validate_frozen_design(design: Any) -> None:
    ...
    if design.get("suiteId") != "corelm-voidtoken-crossmodel-livewiki-v4-author-verified":
...
def verify_private_snapshot_manifest(
    ...
    if (
        value["schemaVersion"]
        != "corelm-crossmodel-livewiki-v4-private-snapshot-manifest-v1"
...
def validate_selection(selection: Any, design: dict[str, Any], snapshot_digest: str):
    ...
    if selection.get("schemaVersion") != "corelm-crossmodel-livewiki-v4-selection-v1":
    ...
    *,
    ...
    for model_key in model_order:
        ...
        if (
            ...
            != "corelm-crossmodel-livewiki-v4-supervisor-receipt-v1"
...
def canonical_scientific_result(
    ...
    *,
    ...
    return {
        "schemaVersion": "corelm-crossmodel-livewiki-v4-result-v1",
