#!/usr/bin/env python3
"""Fetch immutable v4 model assets with exact, fail-closed verification.
...
MANIFEST_SCHEMA = "corelm-crossmodel-livewiki-v4-model-assets-draft-v1"
    ...
    try:
        ...
        request = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "corelm-v4-asset-fetcher/1",
            },
            method="GET",
        )
...
def main() -> int:
    ...
    try:
        ...
        return 1
    summary = {
        "schemaVersion": "corelm-v4-asset-fetch-result-v1",
        "status": (
