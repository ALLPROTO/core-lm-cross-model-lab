#!/usr/bin/env python3
"""Collect and independently replay the registered blind-v4 corpus snapshot.
...
from v4.fetch_assets import (  # noqa: E402
    DEFAULT_MANIFEST,
    AssetFetchError,
    AssetSpecification,
    load_manifest,
...
from v4.preflight import verify_file_beneath  # noqa: E402
from v4.protocol import sha256_bytes  # noqa: E402
...
def _freeze_ready_report(
    *,
    ...
    return {
        "schemaVersion": "corelm-crossmodel-livewiki-v4-collector-run-v1",
    ...
    *,
    ...
    if phase in {"crawl-1", "crawl-2"}:
        ...
        if (
            ...
            raise CollectorCLIError("crawl stage completion manifest differs")
        return {
            "schemaVersion": "corelm-crossmodel-livewiki-v4-collector-stage-run-v1",
