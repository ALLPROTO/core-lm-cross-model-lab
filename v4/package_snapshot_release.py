#!/usr/bin/env python3
"""Build and independently verify the five blind-v4 snapshot release assets.
...
verification.  ``v4.release_receipt`` remains the independent verifier for
...
from v4.protocol import validate_snapshot_registration
...
ATTRIBUTION_SCHEMA = "corelm-crossmodel-livewiki-v4-snapshot-attribution-v1"
SHA256_MANIFEST_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-snapshot-release-sha256-manifest-v1"
)
VERIFICATION_SCHEMA = (
    "corelm-crossmodel-livewiki-v4-snapshot-release-verification-v1"
)
PROJECTS = (
    "de.wikipedia.org",
    "en.wikipedia.org",
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Package or verify the five blind-v4 snapshot release assets"
    )
