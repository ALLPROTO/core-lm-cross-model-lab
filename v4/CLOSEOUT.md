...
signed annotated tag `corelm-crossmodel-livewiki-v4-closeout`, published
strictly before `2026-10-07T18:00:00Z`. Its exact four semantic roles are:
...
`2026-09-27T18:00:00Z`. Its claim is deliberately limited to the named result
...
```sh
python3 -I -B v4/collect_empty_result_root.py \
...
```sh
python3 -I -B v4/package_closeout_release.py package \
...
```sh
python3 -I -B v4/package_closeout_release.py verify-published \
