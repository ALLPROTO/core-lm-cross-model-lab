#!/usr/bin/env python3
"""Verify the offline blind-v4 design draft and known-answer selector."""
...
def main() -> int:
    ...
    registration_path = V4_ROOT / "design-registration.draft.json"
    vector_path = V4_ROOT / "test-vectors" / "selection-v1.json"
    ...
    asset_manifest_path = V4_ROOT / "model-assets.draft.json"
