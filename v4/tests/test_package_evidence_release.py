...
import v4.package_evidence_release as subject

from v4.package_evidence_release import (
    ARTIFACT_PATHS,
...
class EvidenceReleasePackageTests(unittest.TestCase):
    ...
    def build_sources(self, state: str | None) -> dict[str, Path]:
        ...
        github_gate_raw = canonical_line(
            {
                "schemaVersion": (
                    "corelm-crossmodel-livewiki-v4-github-gate-receipt-v1"
                ),
                "fixture": True,
            }
        )
        ...
        freeze_raw = canonical_line(
            with_digest(
                {
                    "schemaVersion": (
                        "corelm-crossmodel-livewiki-v4-freeze-manifest-v1"
                    )
                }
            )
        )
        ...
        snapshot_raw = canonical_line(
            {
                "schemaVersion": "corelm-crossmodel-livewiki-v4-snapshot-v1",
                "suiteId": SUITE_ID,
        ...
        marker = {
            "schemaVersion": "corelm-crossmodel-livewiki-v4-attempt-v1",
            "status": "STARTED",
            "suiteId": SUITE_ID,
            ...
            "labCommit": "3" * 40,
            "labTree": "4" * 40,
            "targetPulseTimestamp": "2026-09-25T18:00:00.000Z",
        ...
        if state in {"PASS", "FAIL_GATES"}:
            ...
            replay_summary = {
                "schemaVersion": (
                    "corelm-crossmodel-livewiki-v4-independent-model-replay-v1"
                ),
                "suiteId": SUITE_ID,
                "attemptId": ATTEMPT_ID,
                "replayComplete": True,
            ...
            outcome = {
                "schemaVersion": "corelm-crossmodel-livewiki-v4-outcome-v1",
                "suiteId": SUITE_ID,
                "attemptId": ATTEMPT_ID,
                "terminalState": state,
                "completedAt": "2026-09-26T19:00:00Z",
            ...
            outcome = {
                ...
                "attemptId": ATTEMPT_ID,
                "terminalState": state,
                "completedAt": "2026-09-26T18:01:00Z",
                "attemptMarkerFileSHA256": sha256_bytes(marker_raw),
                "resultSHA256": None,
