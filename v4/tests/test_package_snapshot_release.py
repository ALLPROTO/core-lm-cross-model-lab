...
from v4.package_snapshot_release import (
    ASSET_NAMES,
    ASSET_ROLES,
    ...
    def _build_sources(self) -> None:
        ...
        for project_index, project in enumerate(PROJECTS):
                ...
                crawls.append(
                    {
                        ...
                        "notBefore": (
                            ...
                            if crawl_index == 1
                            else "2026-09-23T06:00:00Z"
                        ),
                        "pages": [
                            {
                                "requestURI": request_uri[:-1].decode("ascii"),
                                "serverDate": (
                                    "2026-09-22T06:00:01Z"
                                    if crawl_index == 1
                                    else "2026-09-23T06:00:01Z"
                                ),
            ...
            revision_archive = {
                ...
                "serverDate": "2026-09-23T06:00:01Z",
                "requestURIFile": self._write_corpus(
            ...
            inventory = [
                {
                    ...
                    "revid": revid,
                    "userid": 500 + project_index,
                    "timestamp": f"2026-09-08T00:00:0{project_index}Z",
                    "username": f"Author-{project_index}",
                    "title": title,
