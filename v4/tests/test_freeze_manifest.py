...
from v4 import development_artifact_verifier
from v4 import development_model_replay
from v4 import freeze_manifest as subject
from v4 import run_real_e2e_control
...
class FreezeManifestTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        collect_github_gate_receipt_to_path(
            ...
            now=lambda: "2026-09-06T10:05:10Z",
        )
    ...
    def _live_git_fixture(self) -> tuple[Path, Path, dict[str, str]]:
        ...
        dependency = repository / "v4" / "release_receipt.py"
    ...
    def _write_assets(self) -> None:
        manifest_path = subject.V4_ROOT / "model-assets.draft.json"
    ...
    def _pud_plan_fixture(
        ...
        design = load_json_strict(subject.V4_ROOT / "design-registration.draft.json")
        ...
        for model_key in subject.MODEL_KEYS:
        ...
        base_plan: dict[str, Any] = {
            ...
            "modelExecutionOrder": list(subject.MODEL_KEYS),
        ...
        configuration = {
            "schemaVersion": (
                "corelm-crossmodel-v4-real-e2e-development-configuration-v1"
            ),
            "suiteId": subject.DEVELOPMENT_SUITE_ID,
            "countsTowardScientificVerdict": False,
            "usedForCandidateSelectionOrTuning": False,
    ...
    def _pud_report_fixture() -> dict[str, Any]:
        ...
        phases = [
            ...
            *(f"before-producer:{model}" for model in subject.MODEL_KEYS),
    ...
    def test_live_source_verifier_rejects_dirty_dependency_and_untracked_path(
        ...
        with mock.patch.object(subject, "PROJECT_ROOT", repository):
            ...
            untracked = repository / "v4" / "github_gate_receipt.py"
    ...
    def test_generator_is_canonical_binds_inputs_and_has_no_file_self_reference(self) -> None:
        ...
        schema = load_json_strict(
            subject.V4_ROOT / "schemas" / "freeze-manifest.schema.json"
        )
    ...
    def test_validator_rejects_cross_identity_extra_field_and_self_digest_tampering(self) -> None:
        ...
        tampered["createdAt"] = "2026-09-06T10:07:00Z"
    ...
    def test_decision_checkpoint_and_publication_deadline_fail_closed(self) -> None:
        ...
        late_gate["createdAt"] = "2026-09-06T12:00:02Z"
        ...
        late_freeze["createdAt"] = "2026-09-07T00:00:01Z"
    ...
    def test_stage_two_design_binds_exact_manifest_file_sha(self) -> None:
        ...
        design = copy.deepcopy(
            load_json_strict(subject.V4_ROOT / "design-registration.draft.json")
        )
        design.update(
