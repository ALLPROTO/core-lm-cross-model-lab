...
from v4 import build_frozen_design as subject
...
from v4.reproducibility import canonical_json_bytes, sha256_bytes, with_content_digest
from v4.tests import test_freeze_manifest as freeze_fixture
...
class FrozenDesignBuilderTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        (self.lab_root / "v4").mkdir(parents=True)
        self.draft_raw = (subject.V4_ROOT / "design-registration.draft.json").read_bytes()
    ...
    def _arguments(self, **overrides: object) -> dict[str, object]:
        arguments: dict[str, object] = {
            ...
            "signing_public_key_path": subject.V4_ROOT
            / "signing/corelm-crossmodel-v4-signing.pub",
    ...
    def test_late_manifest_is_rejected_before_output(self) -> None:
        ...
        manifest["createdAt"] = "2026-09-07T00:00:01Z"
