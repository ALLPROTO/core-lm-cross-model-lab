...
from v4.collect_empty_result_root import (
    AUDIT_REPORT_NAME,
    OBSERVATION_NAME,
...
class EmptyResultRootCollectorTests(unittest.TestCase):
    ...
    def test_collects_exact_empty_inventory_and_supporting_bytes(self) -> None:
        times = iter(("2026-09-27T18:00:00Z", "2026-09-27T18:00:01Z"))
        output = self.root / "audit"
        with patch("v4.collect_empty_result_root._utc_now", side_effect=lambda: next(times)):
    ...
    def test_nonempty_symlink_and_predeadline_roots_fail_without_output(self) -> None:
        ...
        times = iter(("2026-09-27T17:59:59Z", "2026-09-27T18:00:00Z"))
        with patch("v4.collect_empty_result_root._utc_now", side_effect=lambda: next(times)):
