...
from v4 import mediawiki_snapshot as subject


SERVER_DATE = "Wed, 23 Sep 2026 06:00:01 GMT"
...
class MediaWikiSnapshotTests(unittest.TestCase):
    ...
    @staticmethod
    def clock() -> datetime:
        return datetime(2026, 9, 23, 6, 0, 2, tzinfo=timezone.utc)
    ...
    def collect_two_stages(
        ...
        subject.collect_crawl_stage(
            ...
            crawl_index=0,
            transport=transport,
            clock=lambda: datetime(2026, 9, 22, 6, 0, 2, tzinfo=timezone.utc),
        )
        subject.collect_crawl_stage(
            root=self.root,
            crawl_index=1,
    ...
    def test_crawl_fails_on_old_date_duplicate_and_continuation_cycle(self) -> None:
        ...
        def old_date(uri: str) -> subject.ArchivedHTTPResponse:
            return response(
                ...
                date="Tue, 22 Sep 2026 05:59:59 GMT",
            )
    ...
    def test_two_durable_crawl_stages_can_run_on_separate_days(self) -> None:
        ...
        first_day = lambda: datetime(
            2026, 9, 22, 6, 0, 2, tzinfo=timezone.utc
        )
        subject.collect_crawl_stage(
            root=self.root,
            crawl_index=0,
