#!/usr/bin/env python3
"""Build the external, canonical blind-v4 frozen-design release asset.
...
artifact-binding changes accepted by :func:`v4.runner.validate_frozen_design`.
...
from v4.runner import RunnerError, validate_frozen_design  # noqa: E402
...
DRAFT_RELATIVE_PATH = "v4/design-registration.draft.json"
