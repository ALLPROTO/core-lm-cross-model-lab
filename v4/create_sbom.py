#!/usr/bin/env python3
"""Build a deterministic CycloneDX SBOM from verified v4 provenance receipts."""
...
from v4.protocol import load_json_strict  # noqa: E402
...
def build_sbom(runtime: dict[str, Any], assets: dict[str, Any]) -> dict[str, Any]:
    ...
    if runtime.get("schemaVersion") != "corelm-crossmodel-livewiki-v4-runtime-manifest-v1":
        raise ValueError("unexpected runtime manifest schema")
    if assets.get("schemaVersion") != "corelm-crossmodel-livewiki-v4-asset-receipt-v1":
