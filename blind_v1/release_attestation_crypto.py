...
semantic replay in :mod:`blind_v1.github_release_attestation` then checks every signed
subject.
...
TRACKED_GITHUB_TRUSTED_ROOT = BLIND_V1_ROOT / "trust" / "github" / "trusted_root.json"
