...
from blind_v1 import package_development_control_release as subject
from blind_v1.development_artifact_verifier import FULL_ASSET_RECEIPT_PATH
from blind_v1.reproducibility import canonical_json_bytes, sha256_bytes
    ...
    def setUp(self) -> None:
        ...
        rights_files = {
            ...
            "inputs/development-corpus.draft.json": (
                project_root / "blind_v1/development-corpus.draft.json"
            ).read_bytes(),
