...
from blind_v1 import fetch_assets as subject
...
class FetchAssetsTests(unittest.TestCase):
    ...
    def test_actual_draft_manifest_has_18_assets_and_12_small_assets(self) -> None:
        specifications = subject.load_manifest(subject.DEFAULT_MANIFEST)
        self.assertEqual(len(specifications), 18)
        small = [
            item
