...
from blind_v1.source_archive import (
    MANIFEST_MEMBER,
    SOURCE_PREFIX,
    SourceArchiveError,
...
class SourceArchiveTests(unittest.TestCase):
    ...
    def test_exact_verification_is_gitless_and_wrong_identity_is_rejected(self) -> None:
        ...
        with mock.patch(
            "blind_v1.git_source.subprocess.run",
    ...
    def test_external_ancestor_symlinks_are_rejected_and_output_dir_is_synced(self) -> None:
        ...
        with mock.patch("blind_v1.source_archive.os.fsync", side_effect=recording_fsync):
