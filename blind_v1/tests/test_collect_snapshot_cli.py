...
from blind_v1 import collect_snapshot as subject


MODEL_REVISIONS = {
    "pythia-160m": "50f5173d932e8e61f858120bcb800b97af589f46",
    "pythia-70m": "a39f36b100fe8a5377810d56c3f4789b9c53ac42",
    "smollm-135m": "1d461723eec654e65efdc40cf49301c89c0c92f4",
    "smollm-360m": "59f7ef243ee09a72cbc14cb054393a3e3b771d41",
    "gpt2-124m": "607a30d783dfa663caf39e06633721c8d4cfcd7e",
    "distilgpt2-82m": "2290a62682d06624634c1f46a6ad5be0f47f38aa",
}
...
class CollectorCLIContractTests(unittest.TestCase):
    ...
    def run_phase(self, phase: str, **overrides: Any) -> dict[str, Any]:
        arguments: dict[str, Any] = {
            ...
            "clock": lambda: datetime(2026, 8, 19, 6, 0, 2, tzinfo=timezone.utc),
    ...
    def test_contract_verifies_all_assets_and_loads_owned_tokenizer_bytes(self) -> None:
        def stage(**arguments: Any) -> dict[str, Any]:
            ...
            return {
                ...
                "crawlIndex": 1,
                "notBefore": subject.CRAWL_NOT_BEFORE[0].strftime(
                    "%Y-%m-%dT%H:%M:%SZ"
                ),
        ...
        self.assertEqual(report["assetFilesVerified"], 12)
        self.assertEqual(report["tokenizerFilesLoaded"], 6)
