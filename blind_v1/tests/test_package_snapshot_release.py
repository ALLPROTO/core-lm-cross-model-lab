...
import blind_v1.package_snapshot_release as package_subject
from blind_v1.package_snapshot_release import (
    ASSET_NAMES,
    ASSET_ROLES,
...
class SnapshotReleasePackageTests(unittest.TestCase):
    ...
    def test_safe_path_cli_help_bootstraps_the_tracked_package(self) -> None:
        completed = subprocess.run(
            (
                sys.executable,
                "-I",
                "-B",
                str(Path(package_subject.__file__).resolve(strict=True)),
                "--help",
            ),
            cwd=Path("/"),
        ...
        self.assertIn(b"Package or verify", completed.stdout)
    ...
    def _build_sources(self) -> None:
        ...
        for project_index, project in enumerate(PROJECTS):
            ...
            revision_archive = {
                ...
                "serverDate": "2026-08-19T06:00:01Z",
                "requestURIFile": self._write_corpus(
            ...
            inventory = [
                {
                    ...
                    "revid": revid,
                    "userid": 500 + project_index,
                    "timestamp": f"2026-08-10T00:00:0{project_index}Z",
                    "username": f"Author-{project_index}",
                    "title": title,
    ...
    def test_cli_verify_emits_canonical_structured_report(self) -> None:
        ...
        completed = subprocess.run(
            [
                ...
                "-B",
                "-m",
                "blind_v1.package_snapshot_release",
                "verify",
                "--corpus-root",
