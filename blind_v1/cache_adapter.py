#!/usr/bin/env python3
"""Variable-layer KV-cache geometry and lossless layout controls for blind_v1.
...
def geometry_from_config(config: Mapping[str, Any]) -> dict[str, int | str]:
    ...
    if model_type not in SUPPORTED_MODEL_TYPES:
        raise ValueError(f"unsupported blind_v1 model_type: {model_type!r}")
