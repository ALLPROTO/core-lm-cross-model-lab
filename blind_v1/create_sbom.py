#!/usr/bin/env python3
"""Build a deterministic CycloneDX SBOM from verified blind_v1 provenance receipts."""
...
def build_sbom(runtime: dict[str, Any], assets: dict[str, Any]) -> dict[str, Any]:
    ...
    if runtime.get("schemaVersion") != "corelm-blind-crossmodel-v1-runtime-manifest-v1":
        raise ValueError("unexpected runtime manifest schema")
    if assets.get("schemaVersion") != "corelm-blind-crossmodel-v1-asset-receipt-v1":
