...
from v3.protocol import canonical_json_bytes, load_json_strict_bytes
...
SIGNER_IDENTITY = "corelm-crossmodel-livewiki-v3-release"
...
def verify_ssh_signing_key(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="corelm-v3-key-check-") as temporary:
...
def verify_archived_ssh_tag_signature(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="corelm-v3-ssh-verify-") as temporary:
        root = Path(temporary)
