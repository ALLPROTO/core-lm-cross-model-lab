...
from v3.preflight import verify_asset_receipt, verify_file_beneath, verify_regular_file
from v3.reproducibility import sha256_bytes, with_content_digest
    ...
    def test_full_asset_receipt_is_bound_to_exact_manifest(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            receipt = with_content_digest(
                {
                    "schemaVersion": "corelm-crossmodel-livewiki-v3-asset-receipt-v1",
