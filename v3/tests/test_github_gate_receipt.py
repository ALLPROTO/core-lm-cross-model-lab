...
from v3.release_receipt import canonical_json_bytes
    ...
    return {
        ...
        "workflow-artifacts": {
            ...
            "artifacts": [
                {
                    "id": 91001,
                    "name": f"author-v3-linux-development-{RUN_ID}-1",
                    "expired": False,
                ...
                {
                    "id": 91002,
                    "name": f"author-v3-macos-development-{RUN_ID}-1",
                    "expired": False,
...
class GitHubGateReceiptTests(unittest.TestCase):
    ...
    def test_success_is_canonical_schema_valid_and_offline_verifiable(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                (f"author-v3-linux-development-{RUN_ID}-1", "b" * 64),
                (f"author-v3-macos-development-{RUN_ID}-1", "c" * 64),
            ),
        )
    ...
    def test_token_proxy_environment_and_exact_four_requests_leave_no_secret(self) -> None:
        ...
        with mock.patch(
            "v3.collect_github_gate_receipt.socket.create_connection", side_effect=refuse
        ):
    ...
    def test_artifact_metadata_digest_is_bound_but_bytes_are_not_claimed(self) -> None:
        ...
        wrong_name["workflow-artifacts"]["artifacts"][0]["name"] = (
            "author-v3-linux-development-999-1"
        )
        ...
        mixed_attempt["workflow-artifacts"]["artifacts"][1]["name"] = (
            f"author-v3-macos-development-{RUN_ID}-2"
        )
