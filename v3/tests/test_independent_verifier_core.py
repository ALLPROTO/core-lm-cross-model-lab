...
from v3 import independent_verifier_core as independent_subject
from v3 import evidence as producer_evidence
from v3 import nist_beacon as producer_nist
from v3 import protocol as producer_protocol
from v3.independent_verifier_core import (
...
from v3.mediawiki_snapshot import ArchivedHTTPResponse
from v3.github_gate_receipt import verify_github_gate_receipt
from v3.state_machine import create_attempt_marker
from v3.tests import test_github_gate_receipt as gate_fixture
from v3.tests.test_evidence import (
    ATTEMPT,
    BITS,
    CORPORA,
    LAYERS,
...
SELECTION_VECTOR = V3_ROOT / "test-vectors" / "selection-v1.json"
NIST_VECTOR = V3_ROOT / "test-vectors" / "nist-chain1-pulse1.json"
NIST_PEM = V3_ROOT / "test-vectors" / "nist-chain1-cert.pem"
...
class IndependentVerifierDifferentialTests(unittest.TestCase):
    ...
    def test_normative_nist_chain_root_and_current_profile_are_independent(self) -> None:
        manifest = V3_ROOT / "trust" / "nist" / "manifest.json"
        bundle = load_independent_trust_bundle(
            manifest,
    ...
    def test_scientific_paths_are_unaffected_by_monkeypatched_producer(self) -> None:
        ...
        fake_worker = types.ModuleType("v3.model_worker")
        fake_worker.validate_job = Mock(side_effect=poison)
        with patch.dict(sys.modules, {"v3.model_worker": fake_worker}):
    ...
    def test_module_has_no_producer_scientific_import(self) -> None:
        source = (V3_ROOT / "independent_verifier_core.py").read_text(encoding="utf-8")
        for forbidden in (
            "from v3.evidence", "from v3.protocol", "from v3.nist_beacon",
            "from v3.model_worker", "from v3.mediawiki_snapshot",
        ):
    ...
    def test_github_gate_is_replayed_against_author_verification_and_ci(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch.object(
                gate_fixture, "NOW", "2026-08-14T11:58:10Z"
            ):
                gate_raw = collect_gate_fixture(
                    private_root,
                    gate_base_bodies(),
                    base=datetime(2026, 8, 14, 11, 58, tzinfo=timezone.utc),
                )
            ...
            freeze = {
                "schemaVersion": "corelm-crossmodel-livewiki-v3-freeze-manifest-v1",
                ...
                "developmentControl": {
                    ...
                    "artifactCount": 2088,
                    "completedAt": "2026-08-14T11:50:00Z",
                    "archivePublishedAt": "2026-08-14T11:51:00Z",
                    "archiveAttestedAt": "2026-08-14T11:52:00Z",
