...
from v3 import nist_beacon as subject
from v3.mediawiki_snapshot import ArchivedHTTPResponse, archive_response
...
TRACKED_TRUST_MANIFEST_SHA256 = (
    "f6439072fe135fea2677a3fd4e342148c0458b9e58417b9bbe9427692c1b4ecf"
)
...
class NISTBeaconTests(unittest.TestCase):
    ...
    def test_tracked_normative_chain_requires_the_preregistered_root(self) -> None:
        target_time = datetime(2026, 9, 2, 18, 0, 0, tzinfo=timezone.utc)
        bundle = subject.load_offline_trust_bundle(
