...
from v3 import collect_snapshot as subject
...
class CollectorCLIContractTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        manifest = {
            "schemaVersion": "corelm-crossmodel-livewiki-v3-model-assets-draft-v1",
    ...
    def run_phase(self, phase: str, **overrides: Any) -> dict[str, Any]:
        arguments: dict[str, Any] = {
            ...
            "clock": lambda: datetime(2026, 8, 25, 6, 0, 2, tzinfo=timezone.utc),
    ...
    def test_contract_verifies_all_assets_and_loads_owned_tokenizer_bytes(self) -> None:
        def stage(**arguments: Any) -> dict[str, Any]:
            ...
            return {
                ...
                "crawlIndex": 1,
                "notBefore": "2026-08-30T06:00:00Z",
