...
from v3 import package_development_control_release as subject
from v3.development_artifact_verifier import FULL_ASSET_RECEIPT_PATH
from v3.reproducibility import canonical_json_bytes, sha256_bytes
    ...
    def setUp(self) -> None:
        ...
        rights_files = {
            ...
            "inputs/development-corpus.draft.json": (
                project_root / "v3/development-corpus.draft.json"
            ).read_bytes(),
