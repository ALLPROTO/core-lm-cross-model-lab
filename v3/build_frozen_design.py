#!/usr/bin/env python3
"""Build the external, canonical blind-v3 frozen-design release asset.
...
artifact-binding changes accepted by :func:`v3.runner.validate_frozen_design`.
...
from v3.runner import RunnerError, validate_frozen_design  # noqa: E402
...
DRAFT_RELATIVE_PATH = "v3/design-registration.draft.json"
