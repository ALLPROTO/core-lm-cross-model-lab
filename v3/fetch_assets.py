#!/usr/bin/env python3
"""Fetch immutable v3 model assets with exact, fail-closed verification.
...
MANIFEST_SCHEMA = "corelm-crossmodel-livewiki-v3-model-assets-draft-v1"
    ...
    try:
        ...
        request = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "corelm-v3-asset-fetcher/1",
            },
            method="GET",
        )
...
def main() -> int:
    ...
    try:
        ...
        return 1
    summary = {
        "schemaVersion": "corelm-v3-asset-fetch-result-v1",
        "status": (
