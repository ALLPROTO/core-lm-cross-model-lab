...
```sh
python3 -I -B v3/package_evidence_release.py package \
...
python3 -I -B v3/package_evidence_assets.py verify \
...
```sh
python3 -I -B v3/package_evidence_assets.py extract \
  --asset-root /absolute/path/to/evidence-release-assets \
...
3. Create the dedicated evidence tag/release targeting the exact frozen
   ...
   strictly before `2026-09-07T18:00:00Z`. Do not replace a failed/partial
