#!/usr/bin/env python3
"""Second implementation of the blind-v3 scientific verification rules.
...
SELECTION_DOMAIN = b"corelm-voidtoken-crossmodel-livewiki-v3-author-verified/select\0"
TARGET_UNIX_MILLISECONDS = 1788372000000
TARGET_ENDPOINT = (
...
SNAPSHOT_NOT_BEFORE = datetime(2026, 8, 31, 6, tzinfo=timezone.utc)
SNAPSHOT_DEADLINE = datetime(2026, 9, 1, 18, tzinfo=timezone.utc)

RAW_TOKEN_SCHEMA = "corelm-crossmodel-livewiki-v3-raw-token-evidence-v1"
CONTAINER_SCHEMA = "corelm-crossmodel-livewiki-v3-container-evidence-v1"
PAGE_TOKEN_SCHEMA = "corelm-crossmodel-livewiki-v3-page-token-evidence-v1"
TRUST_SCHEMA = "corelm-crossmodel-livewiki-v3-nist-trust-bundle-v1"
NIST_VERIFY_SCHEMA = "corelm-crossmodel-livewiki-v3-nist-verification-v1"
SELECTION_SCHEMA = "corelm-crossmodel-livewiki-v3-selection-v1"
INDEPENDENT_RESULT_SCHEMA = (
    "corelm-crossmodel-livewiki-v3-independent-verification-v1"
)
WORKER_JOB_SCHEMA = "corelm-crossmodel-livewiki-v3-worker-job-v1"
...
def _validate_snapshot(snapshot: Any, *, allow_fixture: bool) -> bool:
    ...
    if snapshot.get("schemaVersion") == "corelm-crossmodel-livewiki-v3-snapshot-fixture-v1":
        expected = {
    ...
    if snapshot["schemaVersion"] != "corelm-crossmodel-livewiki-v3-snapshot-registration-v1":
