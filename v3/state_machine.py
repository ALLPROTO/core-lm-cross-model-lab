#!/usr/bin/env python3
"""Durable, fail-closed state transitions for the blind-v3 one-shot.
...
def create_attempt_marker(
    ...
    *,
    ...
    reservation = {
        "schemaVersion": "corelm-crossmodel-livewiki-v3-attempt-reservation-v1",
        "status": "RESERVED",
        **commitments,
...
def _validate_marker(marker: dict[str, Any]) -> dict[str, Any]:
    ...
    if (
        marker.get("schemaVersion") != "corelm-crossmodel-livewiki-v3-attempt-v1"
...
def _validate_outcome(
    ...
    if outcome.get("schemaVersion") != "corelm-crossmodel-livewiki-v3-outcome-v1":
