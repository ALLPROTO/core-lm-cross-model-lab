#!/usr/bin/env python3
"""Pure, offline protocol controls for the prospective blind v3 suite."""
...
DOMAIN = b"corelm-voidtoken-crossmodel-livewiki-v3-author-verified/select\0"
...
DESIGN_RELEASE_DEADLINE = datetime(2026, 8, 15, tzinfo=timezone.utc)
SNAPSHOT_RELEASE_NOT_BEFORE = datetime(2026, 8, 31, 6, tzinfo=timezone.utc)
SNAPSHOT_RELEASE_DEADLINE = datetime(2026, 9, 1, 18, tzinfo=timezone.utc)
...
EXPECTED_DEVELOPMENT_CONTROLS = {
    ...
    "dataset": {
        ...
        "manifestBytes": 1_985,
        "manifestSHA256": "b18149b73be0bb2510759c8ca567c4ab0a9f04f7960eb4c6a44b6eedfbda9634",
    },
    "allowedEntryPoints": [
        {
            "path": "v3/run_real_e2e_control.py",
    ...
    "realDataE2EFreezeGate": {
        ...
        "archiveTag": "corelm-crossmodel-livewiki-v3-development-control",
...
EXPECTED_CONTINUOUS_INTEGRATION = {
    "workflowName": "Author-verified v3 development controls",
    "workflowPath": ".github/workflows/v3-development-controls.yml",
...
def validate_snapshot_registration(snapshot: Any, *, allow_fixture: bool) -> None:
    ...
    if schema == "corelm-crossmodel-livewiki-v3-snapshot-fixture-v1":
        if not allow_fixture:
            raise ValueError("protocol-control snapshot fixture is forbidden here")
        expected_fixture = {
            "schemaVersion": "corelm-crossmodel-livewiki-v3-snapshot-fixture-v1",
            "fixtureOnly": True,
        ...
        return
    if schema != "corelm-crossmodel-livewiki-v3-snapshot-registration-v1":
...
def resolve_selection(
    ...
    *,
    ...
    fixture_mode = (
        ...
        == "corelm-crossmodel-livewiki-v3-snapshot-fixture-v1"
    )
    ...
    return {
        "schemaVersion": "corelm-crossmodel-livewiki-v3-selection-v1",
        "suiteId": SUITE_ID,
...
def validate_design_registration(registration: Any) -> list[str]:
    ...
    if registration.get("schemaVersion") != "corelm-crossmodel-livewiki-v3-design-draft-v1":
    ...
    expected_design_release = {
        ...
        "signingPublicKeySHA256": "beac537f2979026cd85facd195132979a5a3a77da65f87d563ffb6253d408ea2",
    }
    ...
    expected_future_corpus = {
        ...
        "creationInterval": {
            "startInclusive": "2026-08-16T00:00:00Z",
            "endExclusive": "2026-08-30T00:00:00Z",
        },
        "snapshotPolicy": "union-of-two-complete-archived-recentchanges-crawls",
        "firstCrawlNotBefore": "2026-08-30T06:00:00Z",
        "secondCrawlNotBefore": "2026-08-31T06:00:00Z",
    ...
    expected_evidence_release = {
        ...
        "publishNoLaterThan": "2026-09-07T18:00:00Z",
        "sourcePolicy": "EXACT_FROZEN_DESIGN_LAB_SOURCE_COMMIT_TREE",
        "serverTimestampRequired": True,
        "immutableReleaseRequired": True,
        "signedAnnotatedTagRequired": True,
    ...
    expected_closeout_release = {
        "tag": "corelm-crossmodel-livewiki-v3-closeout",
        "publishNoLaterThan": "2026-09-14T18:00:00Z",
        "sourcePolicy": "EXACT_FROZEN_DESIGN_LAB_SOURCE_COMMIT_TREE",
        "serverTimestampRequired": True,
        "immutableReleaseRequired": True,
        "signedAnnotatedTagRequired": True,
    ...
    expected_reschedule_policy = {
        "decisionCheckpoint": "2026-08-14T12:00:00Z",
    ...
    for model in models:
        ...
        if model.get("usedForCandidateSelectionOrTuning") is not False:
            raise ValueError("v3 model was used for candidate selection or tuning")
    ...
    expected_execution = {
        ...
        "independentModelReplay": {
            ...
            "implementation": "v3/independent_model_replay.py",
        ...
        "oneShotNotBefore": "2026-09-03T18:00:00Z",
        "hardDeadline": "2026-09-04T18:00:00Z",
    }
    if registration.get("execution") != expected_execution:
        raise ValueError("execution boundary differs")
    expected_beacon = {
        "targetTimestamp": "2026-09-02T18:00:00.000Z",
        "targetUnixMilliseconds": 1788372000000,
        "pulseEndpoint": "https://beacon.nist.gov/beacon/2.0/pulse/time/1788372000000",
        "pulseVersion": "2.0",
        "pulseCipherSuite": 0,
        "pulsePeriodMilliseconds": 60000,
        "transportCABundleSHA256": "22b557a27055b33606b6559f37703928d3e4ad79f110b407d04986e1843543d1",
        "offlineTrustBundleSHA256": "f6439072fe135fea2677a3fd4e342148c0458b9e58417b9bbe9427692c1b4ecf",
...
def validate_frozen_design_registration(registration: Any) -> list[str]:
    ...
    if set(registration) != EXPECTED_TOP_LEVEL_FIELDS:
        raise ValueError("design registration top-level fields differ")
    if registration.get("schemaVersion") != "corelm-crossmodel-livewiki-v3-design-v1":
    ...
    normalized["schemaVersion"] = "corelm-crossmodel-livewiki-v3-design-draft-v1"
...
def validate_design_registration_lifecycle(registration: Any) -> list[str]:
    ...
    if identity == (
        "corelm-crossmodel-livewiki-v3-design-draft-v1",
...
def validate_model_asset_manifest(
    ...
    if manifest.get("schemaVersion") != "corelm-crossmodel-livewiki-v3-model-assets-draft-v1":
