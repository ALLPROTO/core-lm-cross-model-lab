#!/usr/bin/env python3
"""Build and independently verify a blind-v3 public evidence package.
...
replace ``v3/verify_evidence.py``, which independently recomputes the scientific
...
SCHEMA_VERSION = "corelm-crossmodel-livewiki-v3-evidence-release-manifest-v1"
VERIFICATION_SCHEMA = (
...
TARGET_PULSE_TIMESTAMP = "2026-09-02T18:00:00.000Z"
ONE_SHOT_NOT_BEFORE = "2026-09-03T18:00:00Z"
HARD_DEADLINE = "2026-09-04T18:00:00Z"
...
def _validate_marker(raw: bytes) -> dict[str, Any]:
    ...
    if (
        marker["schemaVersion"] != "corelm-crossmodel-livewiki-v3-attempt-v1"
...
def _validate_outcome(
    ...
    if (
        outcome["schemaVersion"] != "corelm-crossmodel-livewiki-v3-outcome-v1"
...
def _verify_inner_evidence_manifest(
    ...
    if manifest["schemaVersion"] != "corelm-crossmodel-livewiki-v3-evidence-manifest-v1":
